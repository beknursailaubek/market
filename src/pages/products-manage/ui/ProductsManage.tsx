...
import { ProductsTable } from "@/widgets/products/ProductTable";
import { Product } from "@/entities/product/types";
import { getStaticProducts } from "@/entities/product/model";
  ...
  return (
    <div className="p-[30px] h-full flex flex-col">
      ...
      <div className="flex items-center justify-between mt-[31px] bg-[#F9F9FB] border-[0.6px] border-[#D5D5D5] rounded-[8px]">
        ...
        <div className="relative mr-[22.5px] text-sm opacity-[50%]">
          <svg width={24} height={24} className="absolute left-[-25px] top-[50%] translate-y-[-50%] opacity-50">
